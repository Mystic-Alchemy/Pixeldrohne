...
def radio_list():
    ...
    remb.add_field(name="Big B Radio J-Pop", value="bigb-j")
    remb.add_field(name="Big B Radio K-Pop", value="bigb-k")
    remb.add_field(name="Bollywood Radio", value="bollywood")
    remb.add_field(name="Ibiza Global Radio", value="ibiza")
